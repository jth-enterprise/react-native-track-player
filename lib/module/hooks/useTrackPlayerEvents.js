  ...
  useEffect(() => {
    if (__DEV__) {
      ...
      if (invalidTypes.length) {
        console.warn('One or more of the events provided to useTrackPlayerEvents is ' + `not a valid TrackPlayer event: ${invalidTypes.join("', '")}. ` + 'A list of available events can be found at ' + 'https://doublesymmetry.github.io/react-native-track-player/docs/api/events');
      }
    }
